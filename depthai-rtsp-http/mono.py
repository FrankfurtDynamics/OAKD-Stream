...
parser.add_argument("-wt",  "--width",     default=1280,        type=int,   help="Width of the video/preview size. In multiple of 32")
parser.add_argument("-ht",  "--height",    default=800,        type=int,   help="Height of the video/preview size. In multiple of 8")
...
if __name__ == "__main__":
    ...
    colorCam.setBoardSocket(dai.CameraBoardSocket.LEFT)
    #colorCam.setResolution(dai.ColorCameraProperties.SensorResolution.THE_1080_P)
    colorCam.setResolution(dai.MonoCameraProperties.SensorResolution.THE_800_P)
   ...
   # if SCALE_ON is True:
    ...
    colorCam.out.link(videnc.input)
